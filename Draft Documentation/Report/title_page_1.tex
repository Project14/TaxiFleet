...
The following table shows the product backlog for the front-end of the WitsCABS application including features implemented in the prototype and features still to be added in possible future sprints.\\
\begin{tabular}{|c|l|c|}
\hline 
